...
export default function Top({ navigation, route }) {
  ...
  const APIURL = `https://api.themoviedb.org/3/movie/top_rated?sort_by=popularity.desc&api_key=c417b9996e32c1b5ea31b6d166a52ff9&page=${page}`;
  ...
  return (
    ...
    >
      <Header
        name={language ? "Top Rated" : "الافلام الاعلى تقييماً"}
        onScrollY={onScrollY}
